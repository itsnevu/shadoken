...
export class MenuScene extends Phaser.Scene {
  ...
  create(): void {
    ...
    this.cameras.main.setBackgroundColor('#16191d');
    ...
    if (this.textures.exists('logo')) {
      this.add.image(cx, cy - 118, 'logo').setOrigin(0.5).setScale(0.5).setAlpha(0.9);
    }
    ...
    this.add
      ...
      .setOrigin(0.5)
      .setShadow(0, 6, '#b62519', 12, false, true);
    ...
    const badgeColor = opts?.multiplayer ? '#ab9ff2' : '#e23b2e';
    this.add
      .text(cx, cy + 42, `◈  ${mode}`, {
        fontFamily: 'Trebuchet MS, system-ui, sans-serif',
        fontSize: '15px',
